...
import { Container,Content, Header, Item, Input, Icon, Button, Text,View,FooterTab,Footer } from 'native-base';
...
export default class SearchBarExample extends Component {
  render() {
    return (
      <Container>
        <Content style={{backgroundColor:'#ff9900'}}>
               <Header style={{width:300,marginLeft:40,marginBottom:20,backgroundColor:'#ff9900'}} searchBar rounded>
          <Item style={{width:300,backgroundColor:'white'}} >
          ...
          <View style={{backgroundColor:'white'}}>
            <Text style={{marginLeft:20,marginTop:10,fontWeight:'bold',color:'black'}}>Browse categories</Text>
          </View>
